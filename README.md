...
Also check out [this repo](https://github.com/TraeRegan/PHP-5--RESTful-API-Template) for a similar RESTful API template, using the Epiphany framework, which is for PHP 5+.